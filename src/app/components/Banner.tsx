...
export default function Banner() {
    ...
    return (
        ...
        <div className="relative flex h-screen content-center items-center pt-16 pb-32">
            <div className="absolute top-0 h-[615px] w-full bg-[url('/src/app/assets/images/main.jpg')] bg-cover bg-center" />
            <div className="absolute top-0 h-[615px] w-full bg-gradient-to-r from-WHITE via-WHITE via-25% to-TRANSPARENT bg-cover bg-center" />
